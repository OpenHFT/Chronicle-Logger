...
public class ChronicleHandlerHelper {
    ...
    static {
        ...
        julToCHronicleLevelMap.put(Level.ALL     , ChronicleLogLevel.DEBUG);
        julToCHronicleLevelMap.put(Level.CONFIG  , ChronicleLogLevel.DEBUG);
        julToCHronicleLevelMap.put(Level.FINEST  , ChronicleLogLevel.DEBUG);
        julToCHronicleLevelMap.put(Level.FINER   , ChronicleLogLevel.DEBUG);
        julToCHronicleLevelMap.put(Level.FINE    , ChronicleLogLevel.TRACE);
