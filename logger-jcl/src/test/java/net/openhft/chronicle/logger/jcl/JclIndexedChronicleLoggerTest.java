...
public class JclIndexedChronicleLoggerTest extends JclTestBase {
    ...
    public void testIndexedLogger() {
        ...
        assertTrue(cl1.writer().getChronicle() instanceof IndexedChronicle);
        assertTrue(cl1.writer() instanceof ChronicleLogWriters.SynchronizedWriter);
        ...
        assertTrue(cl2.writer().getChronicle() instanceof IndexedChronicle);
        assertTrue(cl2.writer() instanceof ChronicleLogWriters.SynchronizedWriter);

        ChronicleLogger cl3 = (ChronicleLogger) l3;
        assertEquals(cl3.level(), ChronicleLogLevel.INFO);
        assertEquals(cl3.name(), "logger_1");
        assertTrue(cl3.writer().getChronicle() instanceof IndexedChronicle);
        assertTrue(cl3.writer() instanceof ChronicleLogWriters.SynchronizedWriter);

        ChronicleLogger cl4 = (ChronicleLogger) l4;
        assertEquals(cl4.level(), ChronicleLogLevel.DEBUG);
        assertEquals(cl4.name(), "readwrite");
        assertTrue(cl4.writer().getChronicle() instanceof IndexedChronicle);
        assertTrue(cl4.writer() instanceof ChronicleLogWriters.SynchronizedWriter);
    }
