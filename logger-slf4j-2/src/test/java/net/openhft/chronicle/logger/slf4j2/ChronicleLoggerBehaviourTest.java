...
/**
 * Mirrors the SLF4J 1.x behaviour test to ensure the 2.x logger forwards data
 * in the same way.
 */
public class ChronicleLoggerBehaviourTest {
    ...
    public void captureThreadName() {
        ...
        Thread.currentThread().setName("slf4j2-behaviour-test");
    }
    ...
    public void filtersLevelsAndPreservesArguments() {
        ...
        assertEquals("slf4j2-behaviour-test", first.threadName);
